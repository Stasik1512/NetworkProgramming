...
void main()
{
	...
	hints.ai_flags = AI_PASSIVE; // —оединение работает в режиме "listening"
	...
	//3 BIND -- ѕрив€зываем серверный сокет к интерфейсу, который он будет слушать 
